...
return $oStatusView->getMemberMenuStatuses();',
        ...
        array (
          ...
          array (
            ...
            array (
              'menu_id' => 1,
              'item_link' => 'http://localhost:8080/SE-team-10/Dolphin10/admin',
              'extended_action' => '',
              'cover' => 'top_cover',
...
return BxDolPayments::getInstance()->getCartItems();',
    ...
    array (
      ...
      'menu_caption' => NULL,
      'menu_link' => 'http://localhost:8080/SE-team-10/Dolphin10/administration/',
      'extended_action' => NULL,
      'target' => NULL,
      ...
      array (
        ...
        array (
          ...
          array (
            ...
            array (
              'menu_id' => 5,
              'item_link' => 'http://localhost:8080/SE-team-10/Dolphin10/administration/',
              'extended_action' => '',
              'cover' => 'top_cover',

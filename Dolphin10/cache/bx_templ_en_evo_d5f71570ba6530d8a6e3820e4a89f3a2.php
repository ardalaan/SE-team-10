<div class="admin_actions_panel bx-def-padding-thd-topbottom clearfix">
    <?php if($a['bx_if:selectAll']['condition']){ ?>
        <div class="admin-actions-select bx-def-padding-left">
    ...
    <?php if($a['bx_if:actionButtons']['condition']){ ?>
        <div class="admin-actions-buttons bx-def-padding-left <?=$a['bx_if:actionButtons']['content']['class'];?>">
    ...
    <?php if($a['bx_if:customHTML']['condition']){ ?>
        <div class="admin-actions-custom bx-def-padding-left"><?=$a['bx_if:customHTML']['content']['custom_HTML'];?></div>
    <?php } ?>
</div>

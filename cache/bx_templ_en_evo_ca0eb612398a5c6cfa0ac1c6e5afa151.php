<div class="thumbnail_block <?=$a['sys_thb_float'];?> <?=$a['classes_add'];?>">
	<div class="thumbnail_image" onmouseover="javascript:startUserInfoTimer(<?=$a['iProfId'];?>, this)" onmouseout="javascript:stopUserInfoTimer(<?=$a['iProfId'];?>)">
		<a href="<?=$a['usr_profile_url'];?>" title="<?=$a['usr_thumb_title0'];?>">
			<?php if($a['bx_if:show_thumbnail_image1']['condition']){ ?>
            	<img src="<?=$a['bx_if:show_thumbnail_image1']['content']['usr_thumb_url0'];?>" src-2x="<?=$a['bx_if:show_thumbnail_image1']['content']['usr_thumb_url0_2x'];?>" alt="<?=$a['bx_if:show_thumbnail_image1']['content']['usr_thumb_alt0'];?>" class="thumbnail_image_file bx-def-thumbnail bx-def-shadow bx-img-retina" />
            <?php } ?>

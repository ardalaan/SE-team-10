...
<head>
	...
	<base href="http://localhost:8080/dolphin4/" />	
    ...
    <script type="text/javascript" language="javascript">
		var site_url = 'http://localhost:8080/dolphin4/';
        ...
        oBxUserStatus.userStatusInit('http://localhost:8080/dolphin4/', <?=$this->parseSystemKey('is_profile_page', $mixedKeyWrapperHtml);?>);
	</script>
